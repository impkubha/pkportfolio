...
function pkportfolio_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section( 'pkportfolio_default_cs', array('title' => 'Default section'));

    $wp_customize->add_setting( 'myfooter', array(
        'type' => 'theme_mod',
        'default' => __( '&copy; 2022 Pradeep Khadka - All Rights Reserved', 'pkportfolio' ),
        'sanitize_callback' => $pgwp_sanitize
    ));

    $wp_customize->add_control( 'myfooter', array(
        'label' => __( 'Footer Section', 'pkportfolio' ),
        'type' => 'text',
        'section' => 'pkportfolio_default_cs'
    ));
...
function pkportfolio_blocks_init() {
    ...
    require_once 'blocks/skillsblock/skillsblock_register.php';
    require_once 'blocks/project/project_register.php';
    require_once 'blocks/techstack/techstack_register.php';
    require_once 'blocks/contactsection/contactsection_register.php';
